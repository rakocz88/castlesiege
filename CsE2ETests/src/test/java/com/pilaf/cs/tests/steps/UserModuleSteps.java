...
public class UserModuleSteps extends SpringIntegrationTest {
	...
	public void i_try_to_use_the_user_by_name_rest_enpoint_with_the_username(String username) throws Throwable {
		...
		String user = restTemplate.getForEntity(String.format("http://localhost:14001/test/users/getUser/%s/%s", username, UserTest.getInstance().getAuthorizationToken()), String.class).getBody();
